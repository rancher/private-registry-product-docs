...
* `<RKE2_VERSION_URLENCODED>` with the {rke2a} release you want to install, found on the https://github.com/rancher/rke2/releases[{rke2a} releases page] (for example, `v1.34.5+rke2r1` written as `v1.34.5%2Brke2r1`, since a literal `+` is not valid in a URL).
