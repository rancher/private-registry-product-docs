...
Before beginning the air-gap installation process, ensure you have the following in place:
...
An easy way to air-gap the artifacts is by using a manifest, which is a YAML file with all the artifacts you want to move to the air-gap environment. The manifest file allows you to declaratively define which Helm charts, container images, and files are required for your deployment. This approach provides several benefits:
...
==== 4. Synergy: Orchestrating Hauler with SUSE Private Registry
