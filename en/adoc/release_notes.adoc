...
* Update {harbor} 2.14.2 to 2.14.4 (link:https://github.com/goharbor/harbor/releases/tag/v2.14.4[Release Notes v2.14.4])
* {trivy} version update 0.68.2 to to 0.70.0 with adapter v0.36.0 (link:https://github.com/aquasecurity/trivy/releases/tag/v0.70.0[Release Notes v0.70.0]).
* {nginx} version update 1.21 to 1.27.2 (link:https://github.com/nginx/nginx/releases/tag/release-1.27.2[Release Notes v1.27.2])
* {postgres} version update 17.9 to 17.10 (link:https://www.postgresql.org/docs/release/17.10[Release Notes v17.10]).
