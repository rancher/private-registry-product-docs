...
* Updates {harbor} 2.15.1 to 2.15.2 (link:https://github.com/goharbor/harbor/releases/tag/v2.15.2[Release Notes v2.15.2]).
...
* Updates {harbor} 2.15.1 to 2.15.2 (link:https://github.com/goharbor/harbor/releases/tag/v2.15.2[Release Notes v2.15.2]).
* Updates {trivy} to version 0.72.0 (link:https://github.com/aquasecurity/trivy/releases/tag/v0.72.0[Release Notes v0.72.0]) and the Trivy adapter to version 0.38.0.
* Upgrades Go to version 1.26.4.
* Upgrades Harbor UI to Angular 21, Clarity v18, and Node.js v22.
* Updates the registry source tag to `v2.8.3-harbor.1` of the distribution project (link:https://github.com/goharbor/distribution/releases/tag/v2.8.3-harbor.1[Release Notes v2.8.3-harbor.1]).
