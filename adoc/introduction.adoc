...
[#spr-how-does-spr-work]
== How does {productname} work?
{productnameshort} is delivered as _Open Container Initiative_ (OCI) containers and it is expected to be deployed on a {kube} cluster.
...
[#spr-for-more-information]
== For more information
Refer to the following sources to obtain more details:

* The {harbor} project https://goharbor.io/[home page].
