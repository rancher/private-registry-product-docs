...
Security Updates:
* Update Harbor 2.14.1 to 2.14.2 (Release Notes v2.14.2 - https://github.com/goharbor/harbor/releases/tag/v2.14.2)
* Trivy version update 0.67.2 to 0.68.2 (Release Notes v0.68.2 - https://github.com/aquasecurity/trivy/releases/tag/v0.68.2)
